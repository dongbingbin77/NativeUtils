...
public class CalendarReminderUtils {
     ...
     * 添加日历事件
     */
    public static void addCalendarEvent(Context context, String title, String description, long reminderTime, int previousMinutes) {
        if (context == null) {
            return;
        }
        ...
        values.put(CalendarContract.Reminders.MINUTES, previousMinutes);// 提前多少分钟有提醒
