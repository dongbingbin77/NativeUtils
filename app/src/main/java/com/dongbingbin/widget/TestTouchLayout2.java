 ...
 * @Date: 2020/7/15 23:55
 */
public class TestTouchLayout2 extends LinearLayout {
    ...
    public TestTouchLayout2(Context context) {
        super(context);
    }

    public TestTouchLayout2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TestTouchLayout2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
